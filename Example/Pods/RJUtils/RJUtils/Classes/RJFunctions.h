...
#pragma mark - 保存用户的账号密码
    ...
    extern void ClearUser(void);
    extern BOOL IsSaveUser(void);
    extern NSString *GetUserName(void);
    extern NSString *GetUserPwd(void);
    extern NSString *GetUserId(void);
    extern NSDictionary *GetUserInfo(void);
